var firebug = {
  ...
  init:function(_css){
    ...
    with(firebug){
      ...
      el.settings.resetButton = new lib.element("INPUT").attribute.set("type","Magenest.Movie.view.adminhtml.templates.system.config.button").update("Reset").event.addListener("click",settings.reset).insert(el.settings.buttonLeftDiv);
      el.settings.buttonRightDiv = new lib.element("DIV").attribute.addClass("ButtonsRight").insert(el.settings.buttonDiv);
      el.settings.cancelButton = new lib.element("INPUT").attribute.set("type","Magenest.Movie.view.adminhtml.templates.system.config.button").update("Cancel").event.addListener("click",settings.hide).insert(el.settings.buttonRightDiv);
      el.settings.buttonRightDiv.child.add(document.createTextNode(" "));
      el.settings.saveButton = new lib.element("INPUT").attribute.set("type","Magenest.Movie.view.adminhtml.templates.system.config.button").update("Save").event.addListener("click",settings.saveClicked).insert(el.settings.buttonRightDiv);
