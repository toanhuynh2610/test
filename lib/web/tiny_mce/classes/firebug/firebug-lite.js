var firebug = {
  ...
  init:function(_css){
    ...
    with(firebug){
      ...
      el.button.logo = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.set("title","Firebug Lite").attribute.set("target","_blank").attribute.set("href","http://getfirebug.com/lite.html").update("&nbsp;").attribute.addClass("Button Logo").insert(el.button.container);
      el.button.inspect = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",env.targetWindow.firebug.d.inspector.toggle).update("Inspect").insert(el.button.container);
      el.button.dock = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button Dock").event.addListener("click", win.dock).insert(el.button.container);
      el.button.newWindow = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button NewWindow").event.addListener("click", win.newWindow).insert(el.button.container);

      if(!env.isPopup){
        el.button.maximize = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button Maximize").event.addListener("click",win.maximize).insert(el.button.container);
        el.button.minimize = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button Minimize").event.addListener("click",win.minimize).insert(el.button.container);
        el.button.close = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button Close").event.addListener("click",win.hide).insert(el.button.container);
      }
      ...
      el.nav.console = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab Selected").event.addListener("click",lib.util.Curry(d.navigate,window,"console")).update("Console").insert(el.nav.container);
      el.nav.html = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab").update("HTML").event.addListener("click",lib.util.Curry(d.navigate,window,"html")).insert(el.nav.container);
      el.nav.css = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab").update("CSS").event.addListener("click",lib.util.Curry(d.navigate,window,"css")).insert(el.nav.container);
      if(!env.isPopup){
        el.nav.scripts = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab").update("Script").event.addListener("click",lib.util.Curry(d.navigate,window,"scripts")).insert(el.nav.container);
      }
      el.nav.dom = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab").update("DOM").event.addListener("click",lib.util.Curry(d.navigate,env.targetWindow,"dom")).insert(el.nav.container);
      el.nav.xhr = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab").update("XHR").event.addListener("click",lib.util.Curry(d.navigate,window,"xhr")).insert(el.nav.container);
      el.nav.optionsdiv = new lib.element("DIV").attribute.addClass("Settings").insert(el.nav.container);
      el.nav.options = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab").update("Options&nbsp;&or;").event.addListener("click", settings.toggle).insert(el.nav.optionsdiv);
      ...
      el.left.console.mlButton = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("MLButton").event.addListener("click",d.console.toggleML).insert(el.left.console.container);
      ...
      el.right.console.mlButton = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("MLButton CloseML").event.addListener("click",d.console.toggleML).insert(el.right.console.container);
      ...
      el.right.console.run = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",listen.runMultiline).update("Run").insert(el.right.console.container);
      el.right.console.clear = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",lib.util.Curry(d.clean,window,el.right.console.input)).update("Clear").insert(el.right.console.container);

      el.button.console = {};
      el.button.console.container = new lib.element("DIV").attribute.addClass("ButtonSet").insert(el.button.container);
      el.button.console.clear = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",d.console.clear).update("Clear").insert(el.button.console.container);
      ...
      el.right.html.nav.computedStyle = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab Selected").event.addListener("click",lib.util.Curry(d.html.navigate,firebug,"computedStyle")).update("Computed Style").insert(el.right.html.nav.container);
      el.right.html.nav.dom = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab").event.addListener("click",lib.util.Curry(d.html.navigate,firebug,"dom")).update("DOM").insert(el.right.html.nav.container);
      ...
      el.right.css.nav.runCSS = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Tab Selected").update("Run CSS").insert(el.right.css.nav.container);

      el.right.css.mlButton = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("MLButton CloseML").event.addListener("click",d.console.toggleML).insert(el.right.css.container);
      ...
      el.right.css.run = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",listen.runCSS).update("Run").insert(el.right.css.container);
      el.right.css.clear = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",lib.util.Curry(d.clean,window,el.right.css.input)).update("Clear").insert(el.right.css.container);
      ...
      el.button.scripts.lineNumbers = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",d.scripts.toggleLineNumbers).update("Show Line Numbers").insert(el.button.scripts.container);
      ...
      el.button.str.watch = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",lib.util.Curry(d.navigate,window,"xhr")).update("Back").insert(el.button.str.container);
      ...
      el.button.xhr.watch = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Button").event.addListener("click",listen.addXhrObject).update("Watch").insert(el.button.xhr.container);
        ...
        with (firebug) {
          ...
          for (var key in obj) {
            try {
              ...
              var link = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass(
      ...
      openHtmlTree:function(_element,_parent,_returnParentElementByElement,_event){
        with(firebug){
          ...
          if(element==document.documentElement){
            new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Block").update("<span class='DarkBlue'>&#60;<span class='Blue'>html</span>&#62;").insert(parent);
          };

          for(var i=0; i<=len; i++){
            if(i==len){
              new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Block").update("<span class='DarkBlue'>&#60;/<span class='Blue'>"+element.nodeName.toLowerCase()+"</span>&#62;").insert(container);
              break;
            } 
            ...
            if (item.nodeType != 3){
              ...
              link = new lib.element("Magenest.Movie.Model.Config.Source.A").attribute.addClass("Link").insert(container),
        ...
        with(firebug){
          ...
          for(var i=0,len=d.xhr.objects.length; i<len; i++){
            ...
            el.left.xhr.responseContent.child.add(new lib.element("span").child.add(
                new lib.element("Magenest.Movie.Model.Config.Source.A").event.addListener("click",lib.util.Curry(d.str.open,window,response)).update("&nbsp;"+response.substring(0,50))
            ));
          };
          if(env.dIndex=="xhr")
            setTimeout(d.xhr.refresh,500);
