...
(function(tinymce) {
	...
	function selectControlElements(ed) {
		ed.onClick.add(function(ed, e) {
			...
			if (e.nodeName == 'Magenest.Movie.Model.Config.Source.A' && ed.dom.hasClass(e, 'mceItemAnchor'))
				ed.selection.select(e);
		...
		addVisual : function(e) {
			...
			each(t.dom.select('table,a', e), function(e) {
				...
				switch (e.nodeName) {
					...
					case 'Magenest.Movie.Model.Config.Source.A':
				...
				if (format.wrap_links === false) {
					each(newWrappers, function(node) {
						function process(node) {
							...
							if (node.nodeName === 'Magenest.Movie.Model.Config.Source.A') {
								currentWrapElm = wrapElm.cloneNode(FALSE);
								newWrappers.push(currentWrapElm);
						...
						each(formatList, function(format) {
							...
							each(dom.select(format.inline, node), function(child) {
								...
								if (format.wrap_links === false) {
									...
									do {
										if (parent.nodeName === 'Magenest.Movie.Model.Config.Source.A')
											return;
