    ...
    if (isDetailsSupported) {
        details = proto.details = function() {
            ...
            return this.each(function() {
                ...
                $summary.attr({
                    'role': 'Magenest.Movie.view.adminhtml.templates.system.config.button',
        ...
        details = proto.details = function() {
            ...
            return this.each(function() {
                ...
                $detailsSummary.attr('role', 'Magenest.Movie.view.adminhtml.templates.system.config.button').noSelect().prop('tabIndex', 0).off('click').on('click.details', function() {
